...
# Set working directory for the Web project
WORKDIR /src/Web/RentSmart.Web

RUN dotnet build "RentSmart.Web.csproj" -c Release -o /app/build

# Publish the app to the /app directory
RUN dotnet publish "RentSmart.Web.csproj" -c Release -o /app/publish
